...
static const PrefixEntry kProcFilterKeywords[] = {
    PE("lineage"), PE("Lineage"), PE("mist"), PE("Mist"),
    PE("omnirom"), PE("aospa"),
    { nullptr, 0 }
};
...
static const char* const kVintfFilterKeywords[] = {
    "lineage", "Lineage", "mist", "Mist", nullptr
};
#endif
...
static const char* const kSpoofedEmptyProps[] = {
    "ro.mist.version", "ro.mist.build.version", "ro.mist.display.version", "ro.mist.version.base",
